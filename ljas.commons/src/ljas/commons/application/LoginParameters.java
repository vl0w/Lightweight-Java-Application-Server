...
public interface LoginParameters extends Serializable {
	...
	/**
	 * Is called, when a client tries to connect to the server.
	 * When an exception gets thrown, the message will be sended to the client!
	 * @param server
	 * @throws Exception The message of the exception will be sended back to the client as an error-message!
	 */
